...
function schema({ colors, styles }) {
    ...
    "colors": {
      ...
      "diffEditor.insertedTextBackground": "${colors.lowerMint}10",
      "diffEditor.removedTextBackground": "${colors.hotRed}20",
      "diffEditor.insertedLineBackground": "${colors.lowerMint}20",
      "diffEditor.removedLineBackground": "${colors.hotRed}20",
      ...
      "editorGroup.dropBackground": "${colors.tealGreen}20",
      ...
      "scrollbarSlider.background": "${colors.darkerGray}80",
      "scrollbarSlider.activeBackground": "${colors.hotRed}40",
      "scrollbar.shadow": "${colors.transparent}",
      ...
      "commandCenter.foreground": "${colors.lightGray}",
      "commandCenter.background": "${colors.bg}",
      "commandCenter.border": "${colors.transparent}",
      "commandCenter.activeForeground": "${colors.lightGray}",
      "commandCenter.activeBackground": "${colors.focus}",
      "commandCenter.activeBorder": "${colors.transparent}",
      "commandCenter.inactiveForeground": "${colors.darkerGray}",
      "commandCenter.inactiveBackground": "${colors.bg}",
      "commandCenter.inactiveBorder": "${colors.transparent}",
      "commandCenter.debuggingForeground": "${colors.black}",
      "commandCenter.debuggingBackground": "${colors.tealGreen}",
      "commandCenter.debuggingBorder": "${colors.transparent}",
      ...
      "debugIcon.continueForeground": "${colors.tealGreen}",
      "debugIcon.disconnectForeground": "${colors.hotRed}",
      "debugIcon.pauseForeground": "${colors.brightYellow}",
      "debugIcon.restartForeground": "${colors.tealGreen}",
      "debugIcon.startForeground": "${colors.tealGreen}",
      "debugIcon.stepBackForeground": "${colors.lowerBlue}",
      "debugIcon.stepIntoForeground": "${colors.lowerBlue}",
      "debugIcon.stepOutForeground": "${colors.lowerBlue}",
      "debugIcon.stepOverForeground": "${colors.lowerBlue}",
      ...
      "debugToolBar.background": "${colors.darkBluishGray}",
      ...
      "editorGroup.dropBackground": "${colors.tealGreen}20",
      "panelSection.dropBackground": "${colors.tealGreen}20",
      "activityBar.dropBorder": "${colors.tealGreen}20",
      "list.dropBetweenBackground": "${colors.tealGreen}20",
      "terminal.dropBackground": "${colors.tealGreen}20",
      "activityBarTop.dropBorder": "${colors.tealGreen}20",
      "list.dropBackground": "${colors.tealGreen}20",
      "sideBar.dropBackground": "${colors.tealGreen}20",
      "panel.dropBackground": "${colors.tealGreen}20",
      "editorGroup.dropIntoPromptBackground": "${colors.tealGreen}33",
      ...
      "panelTitle.inactiveForeground": "${colors.lightGray}99",
      "panelSectionHeader.background": "${colors.black}",
      "panelSectionHeader.foreground": "${colors.lightGray}",
      "panelSectionHeader.border": "${colors.transparent}",
      "button.background": "${colors.hotRed}",
      "button.foreground": "${colors.black}",
      "button.hoverBackground": "${colors.hotRed}90",
      "button.border": "${colors.transparent}",
      "button.secondaryBackground": "${colors.darkBluishGray}",
      "button.secondaryForeground": "${colors.lightGray}",
      "button.secondaryHoverBackground": "${colors.focus}",
      "sideBarSectionHeader.background": "${colors.bg}",
      "sideBarSectionHeader.foreground": "${colors.lightGray}",
      "sideBarSectionHeader.border": "${colors.transparent}",
      "sideBarTitle.background": "${colors.bg}",
      "sideBarTitle.foreground": "${colors.lightGray}",
      "sideBarTitle.border": "${colors.transparent}",
      ...
      "statusBarItem.remoteBackground": "${colors.tealGreen}",
